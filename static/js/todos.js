    ...
    if (!search) {
        ...
        $.get(service, function(data) {
            ...
            $.each(data, function(index) {
                ...
                var mergedDate = new Date(data[index].date + ' ' + data[index].time);
                ...
                function formatDate() {
                    ...
                    var day = mergedDate.getDay();
                    var date = mergedDate.getDate();
                    var month = mergedDate.getMonth();
                    var year = mergedDate.getFullYear();

                    return dayNames[day] + ' ' + monthNames[month] + ' ' +
                        date + ', ' + year;
                }
                ...
                function formatTime() {
                    ...
                    var min = mergedDate.getMinutes();
                    var hour = mergedDate.getHours();
                    var am_pm;
